...
NobleBindings.prototype.stopScanning = function() {
  if (typeof this._stopScanning == "function") return this._stopScanning();
...
NobleBindings.prototype.discoverIncludedServices = function(
  ...
  if (typeof this._discoverIncludedServices == "function")
    return this._discoverIncludedServices(
      peripheralUuidString,
      serviceUuidString,
      serviceUuidsArray
    );
...
NobleBindings.prototype.discoverCharacteristics = function(
  peripheralUuidString,
  serviceUuidString,
  characteristicUuidsArray
) {
  if (typeof this._discoverCharacteristics == "function")
    return this._discoverCharacteristics(
      peripheralUuidString,
      serviceUuidString,
      characteristicUuidsArray
    );
...
NobleBindings.prototype.discoverDescriptors = function(
  ...
  if (typeof this._discoverDescriptors == "function")
    return this._discoverDescriptors(
      peripheralUuidString,
      serviceUuidString,
      characteristicUuidString
    );
...
NobleBindings.prototype.init = function(arg) {
  if (typeof this._init == "function") return this._init(arg);
